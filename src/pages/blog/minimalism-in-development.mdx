export const meta = {
  ...
  excerpt:
    'When developing software, your mindset and approach can make or break your project. Something we like to keep in mind on every project is minimalism.',
  author: 'Khari Johnson',
  authorLink: 'https://gvempire.dev',
  publishDate: 1605898686451,
  timeToRead: '3 min',
  tags: ['gvempire', 'minimalism', 'lifestyle'],
  headerImage:
    'https://images.pexels.com/photos/1036808/pexels-photo-1036808.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
};
